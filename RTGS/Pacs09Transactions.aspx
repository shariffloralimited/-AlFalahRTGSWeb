<%@ Page Title="Daily Transactions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pacs09Transactions.aspx.cs" Inherits="RTGS.Pacs09Transactions" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     <div class="col-md-12">
            <section class="panel">
        <header class="panel-heading">
            <h3>Pacs09 Transactions Report</h3> 
            <hr />     
                     ...
                     <div class="table-responsive">
                         ...
                         <asp:DataGrid ID="BatchChecksGrid" runat="server" AutoGenerateColumns="false"  FooterStyle-Font-Bold="true"
                             ...
                             <Columns>
                                 ...
                                 <asp:BoundColumn DataField = "InstrInfBillNo"            HeaderStyle-BackColor="#c0c0c0" HeaderText="Bill Number" />
                                 <asp:BoundColumn DataField = "InstrInfLcNo"            HeaderStyle-BackColor="#c0c0c0" HeaderText="LC Number" />
                                 <asp:BoundColumn DataField = "InstrInfPartyName"            HeaderStyle-BackColor="#c0c0c0" HeaderText="Party Name" />
                                 <asp:BoundColumn DataField = "InstrInfBranchID"            HeaderStyle-BackColor="#c0c0c0" HeaderText="Branch ID" />
                                 <asp:BoundColumn DataField = "InstrInfOtherInfo"            HeaderStyle-BackColor="#c0c0c0" HeaderText="Others Info" />
                             </Columns>
                         </asp:DataGrid>
                         </div>   
                         </div>
